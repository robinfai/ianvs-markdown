...
void main() {
  ...
  testWidgets('strong emphasis clicks map through hidden delimiters', (
    tester,
  ) async {
  ...
  testWidgets('triple emphasis clicks map through hidden delimiters', (
    tester,
  ) async {
    const line = 'Alpha ***bravo charlie*** omega';
    const source = 'Before\n\n$line\n\nAfter';
...
''';
  ...
  testWidgets(
    'ordered list number gutter clicks place the caret before markers',
    (tester) async {
      const source = 'Before\n\n1. Alpha bravo\n2. Charlie delta\n\nAfter';
      final controller = IanvsMarkdownController(text: source);
      addTearDown(controller.dispose);
      ...
      expect(
        controller.selection,
        TextSelection.collapsed(offset: source.indexOf('1. Alpha bravo')),
      );
      ...
      await tester.tapAt(
        Offset(
          tester.getRect(list).left + 10,
          tester.getRect(second).center.dy,
        ),
      );
      await tester.pumpAndSettle();
      expect(
        controller.selection,
        TextSelection.collapsed(offset: source.indexOf('2. Charlie delta')),
      );
    },
  );
...
$$''');
  ...
  testWidgets('HTML subscript keeps its rendered control on normal click', (
    ...
    const source = 'Before\n\nAlpha <sub>bravo charlie</sub> omega\n\nAfter';
    final controller = IanvsMarkdownController(text: source);
    addTearDown(controller.dispose);
    await tester.pumpWidget(app(controller));
    await tester.pumpAndSettle();
    ...
    await tester.tap(
      find.byKey(const ValueKey('ianvs-markdown-html-subscript')),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('HTML strikethrough keeps its rendered control on normal click', (
    tester,
  ) async {
    const source = 'Before\n\nAlpha <s>bravo charlie</s> omega\n\nAfter';
    final controller = IanvsMarkdownController(text: source);
    addTearDown(controller.dispose);
    await tester.pumpWidget(app(controller));
    await tester.pumpAndSettle();

    await tester.tap(find.byKey(const ValueKey('ianvs-markdown-html-s')));
    await tester.pumpAndSettle();
  ...
  testWidgets('HTML strong keeps its rendered control on normal click', (
    tester,
  ) async {
    const source =
        'Before\n\nAlpha <strong>bravo charlie</strong> omega\n\nAfter';
    final controller = IanvsMarkdownController(text: source);
    addTearDown(controller.dispose);
    await tester.pumpWidget(app(controller));
    await tester.pumpAndSettle();

    await tester.tap(find.byKey(const ValueKey('ianvs-markdown-html-strong')));
    await tester.pumpAndSettle();
  ...
  testWidgets('HTML emphasis keeps its rendered control on normal click', (
    tester,
  ) async {
    const source = 'Before\n\nAlpha <em>bravo charlie</em> omega\n\nAfter';
    final controller = IanvsMarkdownController(text: source);
    addTearDown(controller.dispose);
    await tester.pumpWidget(app(controller));
    await tester.pumpAndSettle();

    await tester.tap(find.byKey(const ValueKey('ianvs-markdown-html-em')));
    await tester.pumpAndSettle();
  ...
  testWidgets('HTML small keeps its rendered control on normal click', (
    tester,
  ) async {
    const source =
        'Before\n\nAlpha <small>bravo charlie</small> omega\n\nAfter';
    final controller = IanvsMarkdownController(text: source);
    addTearDown(controller.dispose);
    await tester.pumpWidget(app(controller));
    await tester.pumpAndSettle();

    await tester.tap(find.byKey(const ValueKey('ianvs-markdown-html-small')));
    await tester.pumpAndSettle();
  ...
  testWidgets(
    'HTML unordered list enters its exact block source on item click',
    (tester) async {
      const list = '<ul>\n<li>Alpha bravo</li>\n<li>Charlie delta</li>\n</ul>';
      final controller = IanvsMarkdownController(
        text: 'Before\n\n$list\n\nAfter',
  ...
  testWidgets('HTML superscript keeps its rendered control on normal click', (
    ...
    const source = 'Before\n\nAlpha <sup>bravo</sup> omega\n\nAfter';
    final controller = IanvsMarkdownController(text: source);
    addTearDown(controller.dispose);
    await tester.pumpWidget(app(controller));
    await tester.pumpAndSettle();
    await tester.tap(find.byKey(const ValueKey('ianvs-markdown-html-sup')));
    await tester.pumpAndSettle();
    expect(
      find.byKey(const ValueKey('ianvs-markdown-active-block')),
      findsNothing,
  ...
  testWidgets('HTML kbd keeps its rendered control on normal click', (
    tester,
  ) async {
    const source = 'Before\n\nAlpha <kbd>bravo</kbd> omega\n\nAfter';
    final controller = IanvsMarkdownController(text: source);
    addTearDown(controller.dispose);
    await tester.pumpWidget(app(controller));
    await tester.pumpAndSettle();

    await tester.tap(find.byKey(const ValueKey('ianvs-markdown-html-kbd')));
    await tester.pumpAndSettle();
  ...
  testWidgets('HTML mark keeps its rendered control on normal click', (
    tester,
  ) async {
    const source = 'Before\n\nAlpha <mark>bravo charlie</mark> omega\n\nAfter';
    final controller = IanvsMarkdownController(text: source);
    addTearDown(controller.dispose);
    await tester.pumpWidget(app(controller));
    await tester.pumpAndSettle();

    await tester.tap(find.byKey(const ValueKey('ianvs-markdown-html-mark')));
    await tester.pumpAndSettle();
