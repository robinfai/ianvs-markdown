...
- Map inactive blockquote and ATX-heading text clicks past hidden `>` / `#`
  prefixes before the block becomes editable, preserving Obsidian's exact
  source caret, word selection, and raw-marker triple-click line selection.
